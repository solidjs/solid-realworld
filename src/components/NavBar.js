...
export default () => {
  ...
  return (<nav class="navbar navbar-light">
    <div class="container">
      <NavLink class="navbar-brand" route="">{ CommonStore.appName.toLowerCase() }</NavLink>
      <ul class="nav navbar-nav pull-xs-right">
        ...
        <Show when={(UserStore.state.currentUser)}
          fallback={<>
            <li class="nav-item">
              <NavLink class="nav-link" route="login">Sign in</NavLink>
            </li>
            <li class="nav-item">
              <NavLink class="nav-link" route="register">Sign up</NavLink>
            </li>
          </>}
        >
          <li class="nav-item">
